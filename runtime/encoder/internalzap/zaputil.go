...
// Package internalzap hosts small utilities for adapting dxlog's
// vendor-neutral runtime to zap encoders. It provides a compact,
// deterministic mapping from dxlog record concepts to zapcore types,
...
import (
	...
	alevel "dirpx.dev/dxlog/apis/level"
	"go.uber.org/zap"
...
// keys empty—dxlog controls those concerns at higher layers.
...
// importing or depending on concrete dxlog record implementations.
...
// ExtractZapLevel reads dxlog's level (typed or string) and maps it to a
...
// MapAPIsLevel converts dxlog's typed level to a zap level. It relies on
